...
Use the same CMake/vcpkg setup as HeartOfMagic. Needs CommonLibSSE-NG + Address Library.

```cmake
add_library(SL_BookXP SHARED plugin/src/Main.cpp)
target_link_libraries(SL_BookXP PRIVATE CommonLibSSE::CommonLibSSE)
```
